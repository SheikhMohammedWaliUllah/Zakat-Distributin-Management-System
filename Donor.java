...
public class Donor extends Person implements RulesAndRegulations {
	...
	private int age;
	public Donor(String name, int age, String nidNo, String phoneNo, long accNo, String bankName, double mainBalance) throws InvalidAgeException {
	...
	public static void DonorInfoStore(Donor d)throws IOException,InvalidAgeException{
		...
		write.println(d.getName()+"\t"+d.getNidNo()+"\t"+d.getAge()+"\t"+d.getPhoneNo()+"\t"+d.getAccNo()+"\t"+d.getBankName()+"\t"+d.getMainBalance());
//		write.println(d.toString());
	...
	public String toString() {
		return ""+super.getName()+"\t"+super.getNidNo()+"\t"+getAge()+"\t"+getPhoneNo()+"\t"+getAccNo()+"\t"+getBankName()+"\t"+getMainBalance();
	}
